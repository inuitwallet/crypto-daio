...
from blocks.models import Block, Info, Orphan, Peer
...
class HealthView(View):
    ...
    def get(request):
        ...
        top_block = (
            Block.objects.exclude(height=None)
            .exclude(time=None)
            .order_by("-height")
            .first()
        )
        ...
        while get_date < now():
            info = Info.objects.get_closest_to(target=get_date)
        ...
        orphan_chart_data = {
            ...
            "series_data": {
                ...
                "extra1": {
                    "tooltip": {"y_start": "There were ", "y_end": " Orphan blocks"},
        ...
        difficulty_chart_data = {
            ...
            "series_data": {
                ...
                "name1": "Difficulty",
                "extra1": {
                    "tooltip": {"y_start": "The network difficulty was ", "y_end": ""},
                    "date_format": "%d %b %Y %H:%M:%S %p",
                },
            },
            "date_format": "%d %b %Y %H:%M:%S %p",
        ...
        return render(
            ...
            "explorer/health.html",
            {
                ...
                "next_block_time_delta": round(next_block_time_delta.seconds / 60, 1),
                "peers": peers,
